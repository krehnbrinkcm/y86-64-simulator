...
void ExecuteStage::setMInput(PipeReg * mreg, uint64_t m_stat, uint64_t m_icode, uint64_t m_cnd,
			     uint64_t m_vale, uint64_t m_vala, uint64_t m_dste, uint64_t m_dstm){
...
void ExecuteStage::CC(uint64_t e_icode, uint64_t num, uint64_t A, 
		      uint64_t B, uint64_t fun, PipeReg * wreg) {
    bool error = false;
...
uint64_t ExecuteStage::ALU(uint64_t e_icode, uint64_t e_ifun, uint64_t e_valA,
			   uint64_t e_valB, uint64_t e_valC, PipeReg * wreg) {
